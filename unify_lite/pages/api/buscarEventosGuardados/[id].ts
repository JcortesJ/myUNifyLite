...
export default async function handler(req:any,res:any){
        try{
            ...
            const query:string = 'SELECT id_evento,evento.nombre,lugar.nombre AS lugar, hora,fecha FROM eventoGuardado NATURAL JOIN evento WHERE id_creador='+req.query.id.toString()+'))';
            const values:string[] = [];
